	...
	<section id="contact">
		<div class="container">
			...
			<div class="align-self-xl-center" data-wow-offset="50" data-wow-delay="0.9s">
				<form action="{{ route('guardaru') }}" method="POST" name="nuevo" enctype="multipart/form-data">
				{{ csrf_field() }}
					<label>NOMBRE</label>
                    ...
                    <p>@if($errors->first('id_tipo')) <i class="form-control">{{$errors->first('id_tipo')}}</i>@endif</p>
